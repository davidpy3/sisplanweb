...
public class UsuarioForm extends org.apache.struts.action.ActionForm{
    ...
    public String getTipo_doc_iden() {
        return tipo_doc_iden;
    }

    public void setTipo_doc_iden(String tipo_doc_iden) {
        this.tipo_doc_iden = tipo_doc_iden;
    }
