...
<html:form action="/repControllerProcess.do?dispatch=getKardexTrabCCosto" onsubmit="Validar(this);return false;">
<br />
...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" class=tabla>
	...
	<tr height=10px valign="middle">
		<td width="100%" colspan=2 align=middle class="TextoAzulTitulo1">Kardex de Trabajadores por Centro de Costo</td>
	</tr>
	<tr height=10px>
		<td width="60%" align="center" >
			...
			<table border="0" width="70%" class="tabla">
				<tr valign="middle" height="25px">
                                ...
                                <tr>
                                    <td class="Titulo2BlancoClaro" bgcolor="#2D466F">&nbsp;&nbsp;Mes</td>
                                    <td class="FondoGris1">
                                         <html:select property="mes" styleClass="Campo">
                                             <html:option value="1">
                                               <c:out value="ENERO"/>
                                             </html:option>
                                             <html:option value="2">
