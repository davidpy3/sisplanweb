...
<body>
<br>
<div class="Titulo1AzulClaro">REPORTES CONTROLLER - INGRESOS POR MES</div>
Compañia: <c:out value="${params['Compania']}" />
<br>
Año: <c:out value="${params['Ano']}" />
<br/><br/>
<c:url var="url" scope="page" value="/repControllerProcess.do">
   <c:param name="dispatch" value="showParamsIngresosPorMes"/>
 </c:url>
 <a href="${url}">Nueva Consulta</a>
 <br>
    <display:table  name="IngresosPorMes" pagesize="12" requestURI=""
             ...
             <display:setProperty name="export.excel.filename" value="IngresosPorMes.xls"/>
