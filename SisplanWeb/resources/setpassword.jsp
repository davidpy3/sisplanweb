...
<!--
	...
	function Limpiar()
	{
		...
		document.forms[0].dispatch.value='getAllUsers';
...
<% 
 ...
 Usuario usuario=(Usuario) session.getAttribute("usrpwd");
 if(usuario==null){%>
...
<html:form action="/userProcess" onsubmit="Validar(this);return false;">
<br />
...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" class=tabla>
   	<tr height=50px valign="middle">
		<td width="100%" colspan=2 align=middle class="TextoAzulTitulo1">Cambiar Contraseña a Usuario</td>
	</tr>
	<tr height=20px>
		<td width="60%" align="center" >
			<table border="0" width="70%" class="tabla">
				...
				<tr valign="middle" height="25px">
				  <td align=right>
                                      <input type="hidden" name="dispatch" value="setPassword"/>
                                      <input type="submit" name="btnIngresar" value="Cambiar" class="boton" ></td>
			         <td>
                                     <input type="button" name="btnLimpiar" value="Regresar"  class="boton" onclick="Limpiar()"></td>
				</tr>
			</table>
		</td>
	</tr>
