...
<html:form action="/repControllerProcess.do?dispatch=getIngSctrVleyEss" onsubmit="Validar(this);return false;">
<br />
...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" class=tabla>
	...
	<tr height=10px valign="middle">
		<td width="100%" colspan=2 align=middle class="TextoAzulTitulo1">Ingresos, SCTR , VLey y Essalud </td>
	</tr>
	<tr height=10px>
