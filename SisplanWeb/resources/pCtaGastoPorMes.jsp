...
<html:form action="/repControllerProcess.do?dispatch=getCtaGastoPorMes" onsubmit="Validar(this);return false;">
<br />
...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" class=tabla>
	...
	<tr height=10px valign="middle">
		<td width="100%" colspan=2 align=middle class="TextoAzulTitulo1">Cuenta de Gasto por Mes</td>
	</tr>
	<tr height=10px>
