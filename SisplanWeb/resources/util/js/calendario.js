...
function show_calendar(str_target, str_datetime) {
  ...
  str_buffer += "</select>\n"+
		"Año : <input class=\"cal_input\" type=\"text\" name=\"anho\" size=\"4\" maxlength=\"4\" value=\""+dt_datetime.getFullYear()+"\" onmouseout=\"parent.opener.saltaanho('"+dt2dtstr(dt_datetime)+"',this.value);\" onchange=\"parent.opener.saltaanho('"+dt2dtstr(dt_datetime)+"',this.value);\">\n"+
    "</font>\n"+
    "</form>\n</td></tr>" +
		"</table>\n" +
		"</td>\n</tr>\n</table>\n" +
