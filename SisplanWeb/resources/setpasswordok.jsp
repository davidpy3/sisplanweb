...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" >
	...
	<tr height=50px valign="middle">
		<td width="100%" colspan=2 align=middle class="TituloAzulClaro">
                <input type="hidden" name="dispatch" value="insertOrUpdate"/>
                <input type="submit" value="Regresar"  class="butStnd" onclick="document.UsuarioForm.dispatch.value='getAllUsers'"/>
                </td>
	</tr>
