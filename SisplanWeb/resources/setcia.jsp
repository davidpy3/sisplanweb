...
<html:form action="/loginUsuario?dispatch=setCia" method="POST" onsubmit="Validar(this);return false;">
<br>
<br>
<br>
<br>
		...
		<td width="60%" align="center" >
			...
			<table border="0" width="70%" class="tabla">
				<tr valign="middle" height="25px">
                                    <td width="100%" colspan=2 align=middle class="Titulo2AzulClaro">Por favor seleccionar <b>Empresa</b>:</td>
				</tr>
                                <tr valign="middle" height="25px">
				...
				<tr>
                                    <td width="50%" class="Titulo2BlancoClaro" bgcolor="#2D466F">&nbsp;&nbsp;Empresa&nbsp;</td>
