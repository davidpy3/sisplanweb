...
<!--
	...
	function Validar(theForm)
	{
		...
		if (theForm.no_cia.value != "" && theForm.fecha.value != "")
		{       
...
<html:form action="/mvmntosCrdtoProcess.do?dispatch=getMvmntoCrdtoByDate" onsubmit="Validar(this);return false;">
<br />
...
<table valign="middle" border="0" width="506px" cellspacing="2" cellpadding="0" class=tabla>
	...
	<tr height=10px valign="middle">
		<td width="100%" colspan=2 align=middle class="TextoAzulTitulo1">Consulta de Cuentas x Cobrar</td>
	</tr>
	<tr height=10px>
		<td width="60%" align="center" >
			...
			<table border="0" width="70%" class="tabla">
				...
				<tr>
                                    <td class="Titulo2BlancoClaro" bgcolor="#2D466F">&nbsp;&nbsp;Fecha&nbsp;<font color="red">*</font></td>
                                    <td class="FondoGris1">
                                        <html:text property="fecha" value="" size="10"  styleId="fecha" onkeyup="this.value=formateafecha(this.value);"  styleClass="Campo"  />

                            <img src="imagenes/cal.gif" alt="Mes/D&iacute;a/A&ntilde;o" width="16" height="16" border="0" id="triggerCala" />
                            <script type="text/javascript">
                                    Calendar.setup({
                                        inputField     :    "fecha",  // id del campo de texto
                                        ifFormat       :    "%d/%m/%Y",  // Formato de la Fecha
                                        showsTime      :    false,       // Flag para mostrar la Fecha
                                        button         :    "triggerCala",// ID del elemento que llamara al calendario
                                ...
                                <tr>
                                    <td class="Titulo2BlancoClaro" bgcolor="#2D466F">&nbsp;&nbsp;Correntista</td>
                                    <td class="FondoGris1">
                                         <html:select property="idCliente" styleClass="Campo">
                                            <option value="0">TODOS</option> 
                                            <c:forEach var="corr" items="${correntistas}">
                                                <html:option value="${corr.idcorrentista}">
                                                <c:out value="${corr.nombre}"/>
                                                </html:option>
                                            </c:forEach>
                                         </html:select>
                                    </td>
