...
<body>
<br>
<div class="Titulo1AzulClaro">REPORTES CONTROLLER - CUENTA DE BALANCE POR MES</div>
...
<c:url var="url" scope="page" value="/repControllerProcess.do">
   <c:param name="dispatch" value="showParamsCtaBalancePorMes"/>
 </c:url>
 <a href="${url}">Nueva Consulta</a>
 <br>
    <display:table  name="CtaBalancePorMes" pagesize="12" requestURI=""
             ...
             <display:setProperty name="export.excel.filename" value="CtaBalancePorMes.xls"/>
